...
import './PostCustDash.css'; 
import { Link } from 'react-router-dom';


export const PostCustDash = () => {
    ...
    <div>
      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          ...
          <Link to='/custProfile'><button className="profile-button" alt='view profile'>Profile</button></Link>
          <Link to='/bookings'><button className="booking-button" alt='view bookings'>Bookings</button></Link>
        </div>
      </nav>
      ...
      <nav className="navbar-secondary">
        <div className="navbar-secondary-links">
          <div className="navbar-dropdown">
            <Link to='/venuesList'><button className="dropdown-button" alt="list of venues">Venues</button></Link>
          ...
          <div className="navbar-dropdown">
          <Link to='/vendorList'><button className="dropdown-button" alt="list of vendors">Vendors</button></Link>
            <div className="dropdown-content">
                <select className="dropdown">
      ...
      <div className="background-section">
        ...
        <div className="overlay-content">
          ...
          <div className="search-dropdowns">
            ...
            <Link to='/vendorList'><button className="search-button">Search</button></Link>
          </div>
        </div>
      </div>
