...
const EventPlannerRegiPage = ()=>{
    ...
    return(
        ...
        <div class="plannerlogin-form">
        <h2><b>Event Planner Registration</b></h2>
        <form>
            <table className='formContent'>
                <tr>
                    <td><label for="username">Username:</label></td>
                    <td><input type="text" id="username" name="username" required placeholder='Enter your user name'/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label for="portfoliolink">Portfolio-link:</label></td>
                    <td><input type="text" id="portfoliolink" name="portfoliolink" required placeholder='Enter link'/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select id="expertise" name="expertise" required>
                            <option value="" disabled selected>Select a your expertise</option>
                            <option value="wedding">Wedding Planner</option>
                            <option value="planner">Small Event Plannner</option>
                            <option value="service">Corporate Event Planner</option>
                            <option value="evenify">College Event Planner</option>
                            <option value="concertplanner">Concert Planner</option>
                        </select>
                    </td>
                </tr>
            </table>
...
export default EventPlannerRegiPage;