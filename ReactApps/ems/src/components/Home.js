...
export default function HomeComponent() {
    ...
    return (
        ...
        <div style={containerStyle}>
            <h1 className="display-4 my-5" style={{ fontFamily: 'Montserrat', fontWeight: 'bold', fontStyle: 'italic', marginTop: '0rem', marginBottom: '2rem' }}>Eventify</h1>
